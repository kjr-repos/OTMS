<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmAddCountry.aspx.cs" Inherits="Admin_frmAddCountry" Title="Untitled Page" %>
                ...
                <table style="width: 98%; height: 133px;">
                    ...
                    <tr>
                        ...
                        <td style="width: 158px;padding-bottom:20px;">
                            <asp:Label ID="Label1" runat="server" ForeColor="#0066FF" Text="CountryName"></asp:Label>
                        </td>
                        <td style="width: 367px">
                    ...
                    <tr>
                        ...
                        <td style="width: 158px; height: 53px;">
                            <asp:Label ID="Label2" runat="server" ForeColor="#0066FF" Text="Description"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 158px">
                            &nbsp;</td>
                        <td style="width: 367px">
                            <asp:Button ID="brnAdd" class="btn btn-primary" runat="server"  Text="Add" 
