        ...
        <table class="style1">
            ...
            <tr>
                ...
                FirstDate&nbsp; </span>
                    ...
                    <br />
                    <br />
                    <asp:Button ID="Button1" runat="server" Text="Get Tender Winners" class="btn btn-Success"
                        OnClick="Button1_Click" Height="36px"
                        Style="font-weight: 700; color: #CC3399" Width="206px" />
                    <br />
                    <br />
                    <br />
                    <br />
            ...
            <tr>
                <td>
                    ...
                    <Report FileName="~\Admin\Reports\TenderWinners.rpt">
                        <Parameters>
